...
func NewRegisterHandler(repository repository.Repository, userService intraprocess.UserIntraprocess, publisher publisher.Publisher, logger *zap.SugaredLogger, metricsClient metrics.Client) RegisterHandler {
	if repository == nil {
